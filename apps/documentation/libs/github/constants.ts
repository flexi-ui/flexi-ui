...
export const REPO_NAME = 'flexi-ui/flexi-ui'
...
export const COMPONENT_THEME_PATH = __PREVIEW__
  ? `${GITHUB_URL}/${REPO_NAME}/tree/feat/v2/packages/theme/src/components`
  : `${GITHUB_URL}/${REPO_NAME}/tree/main/packages/theme/src/components`

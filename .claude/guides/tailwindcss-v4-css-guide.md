...
This guide explains how to write CSS files for components using Tailwind CSS v4 syntax, based on the patterns used in FlexiUI components.
...
1. **Prioritize @apply for Tailwind Utilities**: Use @apply for properties with Tailwind equivalents
...
2. **Keep Focus States Consistent**: Use custom outline styles
...
3. **Use tw-animate-css for Animations**:
...
4. **Group Related Utilities**: Combine in a single @apply statement
...
5. **Preserve Complex CSS Functions**: Keep color-mix(), calc() as regular CSS
...
6. **Use Arbitrary Values When Needed**:
...
2. **Lightning CSS**: v4 uses Lightning CSS for vendor prefixing and modern syntax transforms
3. **@apply Changes**: The @apply directive behavior may vary in v4

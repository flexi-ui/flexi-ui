import type { ButtonVariantProps } from '@flexi-ui/theme'
import type { AriaButtonProps } from '@flexi-ui/use-aria-button'
import type { ReactNode } from 'react'
import type { RippleProps } from '@flexi-ui/ripple'
import type { HTMLFlexiUIProps, PropGetter } from '@flexi-ui/system'

import { useProviderContext } from '@flexi-ui/system'
import { dataAttr } from '@flexi-ui/shared-utils'
import { ReactRef } from '@flexi-ui/react-utils'
import { MouseEventHandler, useCallback } from 'react'
import { useFocusRing } from '@react-aria/focus'
import { chain, mergeProps } from '@react-aria/utils'
import { useDOMRef, filterDOMProps } from '@flexi-ui/react-utils'
import { button } from '@flexi-ui/theme'
import { isValidElement, cloneElement, useMemo } from 'react'
import { useAriaButton } from '@flexi-ui/use-aria-button'
import { PressEvent, useHover } from '@react-aria/interactions'
import { SpinnerProps } from '@flexi-ui/spinner'
import { useRipple } from '@flexi-ui/ripple'

import { useButtonGroupContext } from './button-group-context'

interface Props extends HTMLFlexiUIProps<'button'> {
  /**
   * Ref to the DOM node.
   */
   ...
   * @see https://FlexiUI.org/components/spinner
   */
  spinner?: ReactNode
  /**
...
export function useButton(props: UseButtonProps) {
  ...
  const { buttonProps: ariaButtonProps, isPressed } = useAriaButton(
    ...
    domRef as React.RefObject<Element>,
  )

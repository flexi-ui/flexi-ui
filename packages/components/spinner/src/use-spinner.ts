import type { SpinnerVariantProps, SpinnerSlots, SlotsToClasses } from '@flexi-ui/theme'
import type { HTMLFlexiUIProps, PropGetter } from '@flexi-ui/system-rsc'

import { mapPropsVariants } from '@flexi-ui/system-rsc'
import { spinner } from '@flexi-ui/theme'
import { clsx, objectToDeps } from '@flexi-ui/shared-utils'
import { useMemo, useCallback, Ref } from 'react'

interface Props extends HTMLFlexiUIProps<'div'> {
  /**
   * Ref to the DOM node.
   */

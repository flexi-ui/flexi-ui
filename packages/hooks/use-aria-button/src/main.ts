...
export function useAriaButton(
  ...
  if (deprecatedOnClick && typeof deprecatedOnClick === 'function') {
    warn(
      'onClick is deprecated, please use onPress instead. See: https://github.com/FlexiUI-org/FlexiUI/issues/4292',
      'useButton',
    )
  }
  ...
  const handlePress = (e: PressEvent) => {
    ...
    // See: https://github.com/FlexiUI-org/FlexiUI/issues/4292
    if (isMobile) {

...
/**
 * Checks if a component is a FlexiUI component.
 * @param component - The component to check.
 * @returns `true` if the component is a FlexiUI component, `false` otherwise.
 */
export const isFlexiUIEl = (component: React.ReactComponentElement<any>) => {
  return !!component.type?.render?.displayName?.includes('FlexiUI')
}
